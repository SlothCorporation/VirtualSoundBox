...
export function GlobalNavLayout({
    sideNavContent,
    children }: GlobalNavLayoutProps) {
    const [isSideNavOpen, setIsSideNavOpen] = useState(false);
    return (
        <div className="flex flex-col h-screen">
            <header className="mb-12">
                <nav className="fixed top-0 inset-x-0 h-12 bg-black flex items-center justify-between z-50">
                    <div className="pl-14">
                    ...
                    <div className="ml-auto flex items-center">
                        <button
                            ...
                            className="flex items-center px-2 h-12 hover:bg-[#393939]"
                        >
